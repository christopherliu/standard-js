define('standard_library/utilities/HTML', ['standard_library/utilities/StringUtils', 'es5-shim/es5-shim'], function(StringUtils) {"use strict";
    /**
    ...
    return {
        ...
        /**
         * Given an object with properties, creates an attribute string that can
         * be used
         * in an HTML tag.
         *
        ...
        /**
         * Given an object, creates a query string that can be used in a URL.
         * Handles
         * arrays using PHP/ASP conventions:
         * http://stackoverflow.com/a/1746566/40352
         * (Not all frameworks will support this behavior)
         *
         * @example HEMLEntityUtils.BuildQueryString({"fox": "animal"}) ===
         * "fox=animal"
         *          HTML.BuildQueryString({"array": [1,2]}) ===
         * "array[]=1&array[]=2"
         */
        "buildQueryString" : function(fieldValuePairs) {
        ...
        /**
         * Converts any string to a form suitable for use as an HTML classname.
         * The
         * requirements for an HTML classname are as follows:
         * http://stackoverflow.com/questions/448981/what-characters-are-valid-in-css-class-names
         */
        "convertToClass" : function(s) {
        ...
        "decodeEntities" : (function() {
             ...
             * text.replace(/&#([0-9]{1,4});/gi, function(match, numStr) { var
             * num =
        ...
        /**
         * Converts a string to a slug that can be part of a URL. For example,
         * "Tim's Donuts" becomes "tims-donuts." Equivalent to the web2py
         * implementation.
         */
        "makeURLSlug" : function(s) {
