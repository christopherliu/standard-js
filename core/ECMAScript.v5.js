/**
 Adding support for ECMAScript v5.

 Some of the differences between v5 and v3 (v4 was skipped):
...
if (!Array.prototype.map) {
    Array.prototype.map = function(callback, thisArg) {
        ...
        // where Array is
        // the standard built-in constructor with that name and len is the value
        // of len.
        A = new Array(len);
...
if (!Array.prototype.some) {
    Array.prototype.some = function(fun /*, thisp */) {"use strict";
