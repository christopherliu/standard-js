/*
Utilities useful for JavaScript use in HTML.
...
Example:
	HTMLUtils.BuildAttributeString({"class":"generic",
			"style":"display:none;"})
		== ' class="generic" style="display:none;"'
*/
...
HTMLUtils.ConvertToID = function(s) {
	...
	return s.replace(INVALID_ID_CHARACTERS, "_")
		.replace(INVALID_STARTING_CHARACTERS, "");
};
/**
Converts a string to a slug that can be part of a URL. For example,
"Tim's Donuts" becomes "tims-donuts." Equivalent to the web2py implementation.
*/
HTMLUtils.MakeURLSlug = function(s) {
	var _slugConversions = [   
		[/&\w+;/g, ''], // strip html entities
