 ...
 * @namespace Provides information about when subscribers should view
 *            information about events which have occurred.
 */
 ...
 */
standard_library.core.Publisher = function(publishingMethodAccessor) {"use strict";
    // ------------------------------------------------------------------------
    // Private variables
    var subscribers = [];
